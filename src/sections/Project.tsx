        ...
        {selectedProj && (
          <div className="space-y-6 text-left">
            ...
            <div className="space-y-3">
              <h4 className="text-white font-bold tracking-wide">Project Architecture & Purpose</h4>
            ...
            {/* Technologies list */}
            <div>
              <h4 className="text-white font-bold tracking-wide mb-3">Core Stack Integration</h4>
            ...
            {selectedProj.isPrivate && (
              <div className="p-3.5 rounded-lg bg-yellow-950/20 border border-yellow-500/20 text-xs text-yellow-500/80 flex items-start gap-2 mt-4 leading-relaxed">
                <span>⚠️ This system processes proprietary financial transaction payloads and compliance metrics. Live hosting and public sources are restricted.</span>
              </div>
            )}
          </div>
        )}
